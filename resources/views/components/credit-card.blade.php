...
<div class="my-10 space-y-16 grid gap-x-8 gap-y-4 grid-cols-3">

    <div
        class="relative m-auto h-48 w-80 rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-2xl transition-transform sm:h-56 sm:w-96 sm:hover:scale-110">
